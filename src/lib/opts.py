...
class opts(object):
    def __init__(self):
        ...
        self.parser.add_argument('--data_cfg', type=str,
                                 default=os.path.join(root_dir, 'lib', 'cfg', 'data.json'),
                                 help='load data from cfg')
        self.parser.add_argument("--data_dir",
                                 type=str,
                                 default=os.path.join(root_dir, 'data', 'MOT'))
        ...
        # log
        self.parser.add_argument('--no_bar', action='store_true',
        ...
        self.parser.add_argument('--keep_res', action='store_true',
                                 help='keep the original resolution'
                                      ' during validation.')
        # tracking
        self.parser.add_argument('--test_panda', default=False, help='test on PANDA dataset')
