...
def create_model(arch, heads, head_conv, opt):
    ...
    model = get_model(opt, num_layers=num_layers, heads=heads, head_conv=head_conv)
    return model


def load_model(model, model_path, optimizer=None, resume=False,
               lr=None, lr_step=None, show_error=True):
    start_epoch = 0
    ...
    msg = 'If you see this, your model did not fully load the ' + \
          'pre-trained weights. Please make sure ' + \
